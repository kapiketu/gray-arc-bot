...
function renderPremiumWebsite(site: SiteConfig): string {
  ...
  const productsHtml = site.services.map((item, i) => `
    <div class="group relative bg-[${textColor}]/[0.03] backdrop-blur-sm border border-[${textColor}]/[0.06] rounded-2xl overflow-hidden hover:border-[${textColor}]/[0.12] hover:bg-[${textColor}]/[0.06] transition-all duration-500 hover:-translate-y-1" style="animation: fadeUp 0.6s ease-out ${0.1 * i}s both">
      ...
      <div class="p-7">
        <div class="flex items-start justify-between mb-3">
          <h3 class="text-lg font-semibold" style="color: ${textColor}">${item.name}</h3>
...
<body class="bg-[${bgColor}] text-[${textColor}] antialiased" style="background-color: ${bgColor}; color: ${textColor};">

  <!-- ══════════ NAVBAR ══════════ -->
  <nav class="fixed top-0 w-full z-50 border-b border-black/[0.05] bg-[${bgColor}]/80 backdrop-blur-xl" style="background-color: ${bgColor}CC;">
    <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
      <a href="#" class="flex items-center gap-3">
        <img src="${images.logo}" alt="Logo" class="w-10 h-10 rounded-lg object-cover bg-white">
        <span class="font-bold text-lg tracking-tight" style="color: ${textColor}">${site.businessName}</span>
      </a>
  ...
  <section class="relative min-h-screen flex items-center justify-center overflow-hidden hero-gradient">
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center pt-20">
      <div class="animate-fade-up" style="animation-delay: 0.1s">
        <span class="inline-flex items-center gap-2 text-xs font-semibold tracking-widest uppercase px-4 py-2 rounded-full border border-[${textColor}]/[0.08] bg-[${textColor}]/[0.03] text-[${textColor}]/70 mb-8">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-up" style="animation-delay: 0.6s">
        ...
        <a href="https://wa.me/${site.phoneNumber}" class="group border border-[${textColor}]/[0.12] bg-[${textColor}]/[0.03] backdrop-blur-sm text-[${textColor}] font-semibold py-4 px-8 rounded-full hover:bg-[${textColor}]/[0.08] hover:border-[${textColor}]/[0.2] transition-all duration-300 flex items-center justify-center gap-2">
      ...
      <div class="grid md:grid-cols-2 gap-16 items-center">
        <div class="scroll-reveal">
          ...
          <div class="flex gap-4 mt-8">
            <a href="https://wa.me/${site.phoneNumber}" class="bg-[${textColor}]/[0.06] border border-[${textColor}]/[0.1] text-[${textColor}] font-medium py-3 px-6 rounded-xl hover:bg-[${textColor}]/[0.1] transition-all duration-300">
              Learn More →
            </a>
          </div>
        </div>
  ...
  <!-- ══════════ CONTACT ══════════ -->
  <section id="contact" class="py-24 md:py-32 border-t border-[${textColor}]/[0.06] relative mesh-gradient">
    <div class="max-w-6xl mx-auto px-6">
      <div class="grid md:grid-cols-2 gap-16">
        <div class="scroll-reveal">
          ...
          <div class="mt-10 space-y-6">
            <div class="flex items-start gap-4 group">
              <div class="w-11 h-11 rounded-xl bg-[${textColor}]/[0.05] border border-[${textColor}]/[0.08] flex items-center justify-center text-lg shrink-0 group-hover:bg-[${textColor}]/[0.08] transition">📍</div>
              <div>
            ...
            <div class="flex items-start gap-4 group">
              <div class="w-11 h-11 rounded-xl bg-[${textColor}]/[0.05] border border-[${textColor}]/[0.08] flex items-center justify-center text-lg shrink-0 group-hover:bg-[${textColor}]/[0.08] transition">✉️</div>
              <div>
        ...
        <div class="scroll-reveal">
          <div class="bg-[${textColor}]/[0.03] backdrop-blur-sm border border-[${textColor}]/[0.08] rounded-3xl p-8">
  ...
  <!-- ══════════ FOOTER ══════════ -->
  <footer class="border-t border-[${textColor}]/[0.06] py-10">
