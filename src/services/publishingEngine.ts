...
import { renderPremiumWebsite } from '../routes/viewer';
...
export function exportToReact(site: SiteConfig, templateId = 'GA004'): string {
  ...
  const html = renderPremiumWebsite(site, templateId);
...
export function exportToNextJS(site: SiteConfig, templateId = 'GA004'): string {
