...
import { NormalizedRequest, ProjectType } from '../types/agent.types';
...
// ─────────────────────────────────────────────────────────────────────────────
export function normalizeFromWhatsApp(raw: {
  from: string;          // sender phone number
  messageBody: string;   // full text collected via WhatsApp flow
  mediaUrls?: string[];  // any media/documents shared
}): NormalizedRequest {
  ...
  const projectType = (extract('type') || 'Website') as ProjectType;
...
// ─────────────────────────────────────────────────────────────────────────────
export function normalizeFromDashboard(raw: {
  clientName: string;
  clientPhone: string;
  clientEmail?: string;
  companyName?: string;
...
// ─────────────────────────────────────────────────────────────────────────────
export async function persistNormalizedRequest(req: NormalizedRequest): Promise<string> {
