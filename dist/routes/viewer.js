...
function getCategoryImages(site) {
    ...
    return {
        ...
        products: site.services.map((s) => `https://image.pollinations.ai/prompt/professional%20product%20photography%20of%20${encodeURIComponent(s.name)}%20for%20${encCat}?width=600&height=600&nologo=true`)
    };
}
// ────────────────────────────────────────────────────────
// HELPER PAGES
