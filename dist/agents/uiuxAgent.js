...
exports.runUiuxAgent = runUiuxAgent;
// ─────────────────────────────────────────────────────────────────────────────
...
async function runUiuxAgent(projectId) {
    ...
    const context = (0, aiBase_1.buildSystemContext)('UI/UX Designer Agent — Senior Product Designer with expertise in modern web and mobile interfaces', {
...
Return ONLY the JSON object, no other text.
  `.trim();
    ...
    await (0, orchestrator_1.updateProjectState)(projectId, { uiuxDesign: output });
